...
public enum StatsKey {
	...
	private static HashMap<Class<?>, Integer> classType = new HashMap<>();
	
	static {
		classType.put(int.class, 0);
		classType.put(double.class, 1);
		classType.put(StatsKey.class, 2);
	}
